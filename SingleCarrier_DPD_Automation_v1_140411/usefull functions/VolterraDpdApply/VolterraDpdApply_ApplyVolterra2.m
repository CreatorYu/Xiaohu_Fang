function [VolterraOutput] = VolterraDpdApply_ApplyVolterra2( dataIn , VolterraParameters , VolterraCoeff  )
    Vin  = dataIn  ;
...
%% Used in solving using Newtons Method
    ...
    U = VolterraDpdApply_GenerateMatrixMemoryless( Vin , 0 , PolyOrder ) ;
