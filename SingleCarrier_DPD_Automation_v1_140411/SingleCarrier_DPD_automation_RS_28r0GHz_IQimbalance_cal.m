...
% InI_beforeDPD_path = '5G_100MHz_TM1_1_In_I_500r0_PAPR_8r6_1ms.txt';
% InQ_beforeDPD_path = '5G_100MHz_TM1_1_In_Q_500r0_PAPR_8r6_1ms.txt';
%%%%% 64QAM 200 MHz   2022.10.24
...
%%%%% 64QAM 200 MHz   2022.10.24
InI_beforeDPD_path = '64QAM_200MHz_In_I_2000r0_PAPR_test_1.txt';
InQ_beforeDPD_path = '64QAM_200MHz_In_Q_2000r0_PAPR_test_1.txt';
%%%%% WCDMA 10C - 50 MHz
...
BW        = 400e6;        % Bandwidth of the modulated signal - Used to calculated ACLR and ACPR from the downloaded I/Q signals  %to be linked to signal
PAPR=8.4;
PAPR_limit = 10;
IP_HM2030 = 'TCPIP::192.168.1.101::5025::SOCKET';
...
p_sg= -20;
Fcarrier  = 25.5e9;       % Center frequency of the modulated signal
FramTime  = 0.0512e-3;      % Total frame time for the modulated signal
...
NofIteration     = 8;            % Maximum # of DPD Iterations
...
FsampleTx        = 2000e6;         % The sampling rate of the I/Q input files - In 'ESG' mode the sampling clock of the ESG will be set to the same value       %to be linked to signal
...
%
%
ESGAdd='TCPIP::192.168.1.111::INSTR';   % set the address of signal generator
%
...
PlotSpectrum(In_I_beforeDPD, In_Q_beforeDPD, In_I_beforeDPD, In_Q_beforeDPD) ;
...
%   Cal = load('IQ_Imbalance_M8190_fLO5r0GHz_Freq_Domain');
   Cal = load('IQ_Imbalance_SMA200_fLO25r5GHz_BW_1000MHzFreq_Domain');
...
for IterationCount = 1:NofIteration
    ...
    [~, maxPower, PAPR_input] = checkPower(In_I_cal, In_Q_cal, 1) ;  % Check the PAPR of the input file to be uploaded to the transmitter
...
%     
 ...
 %   Fcarrier_array{1}                 = Fcarrier ;
   ...
   % In_I_cal=I_corr;  In_Q_cal=Q_corr;
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    fun_SMW200A_IQ_upload (I_corr, Q_corr, input_power,  Fcarrier, FsampleTx, ESGAdd);
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%          Mea_DC=PowerSupply_DP821A(DP821A_IP);
          ...
          % I_m=DC(2);
           V_m=28;
           I_m =fun_PowerSupply_HMP2030(IP_HM2030);
           %[V_m,I_m] = fun_PowerSupply_N6705A_Lan(Lan_addr,chan);
            Pdc=28*(I_m-0.001);
           V_m_with_DPD = V_m;
           I_m_with_DPD = I_m;
...
%         V_a_with_DPD = PS_a.voltage;
%         I_a_with_DPD = PS_a.current;
         Pout_measured_with_DPD = AvgPower- Mea_Attenuator_MMWave(Freq);
         pause(1)
         Pdc_measured_with_DPD  =Pdc;
         DE_measured_with_DPD = 100*10^((Pout_measured_with_DPD-30)/10) / Pdc_measured_with_DPD;
     end
...
%         V_a_with_DPD = PS_a.voltage;
%         I_a_with_DPD = PS_a.current;
         Pout_measured_without_DPD = AvgPower- Mea_Attenuator_MMWave(Freq);
         Pdc_measured_without_DPD  = Pdc;
