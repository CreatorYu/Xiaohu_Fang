...
%
IP_HMP='TCPIP::192.168.1.109::5025::SOCKET';
%DP821A_IP='TCPIP0::192.168.1.105::INSTR';        % set the address of voltage source
IP         = '192.168.1.102';                     % set the address of spectrum analyzer
Freq       = Fcarrier;                                    
RefLev     = -5;
FsampleRx = FsampleTx;
...
%          Mea_DC=PowerSupply_DP821A(DP821A_IP);
           ...
           I_m=fun_PowerSupply_HMP2030(IP_HMP);
           V_m=28;
...
%         V_a_with_DPD = PS_a.voltage;
%         I_a_with_DPD = PS_a.current;
         Pout_measured_with_DPD = meanPower_FSW- Mea_Attenuator_MMWave_2(Freq)
         pause(1)
...
%         V_a_with_DPD = PS_a.voltage;
%         I_a_with_DPD = PS_a.current;
         Pout_measured_without_DPD = meanPower_FSW- Mea_Attenuator_MMWave_2(Freq);
