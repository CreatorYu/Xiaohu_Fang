...
path('D:\Matlab\Xiaohu_Fang\SingleCarrier_DPD_Automation_v1_140411\Measurements\Measurement14-Jun-2023_16_47_40',path);
...
In_I_mean=mean(DelayAdjusted_In_I); In_Q_mean=mean(DelayAdjusted_In_Q);
Out_I_mean=mean(DelayAdjusted_Out_I); Out_Q_mean=mean(DelayAdjusted_Out_Q);
DelayAdjusted_Out_I=DelayAdjusted_Out_I-Out_I_mean+In_I_mean;
DelayAdjusted_Out_Q=DelayAdjusted_Out_Q-Out_Q_mean+In_Q_mean;
...
[DelayAdjusted_In_I, DelayAdjusted_In_Q, DelayAdjusted_Out_I, DelayAdjusted_Out_Q, timedelay1] = AdjustDelay_zero(InI, InQ, DelayAdjusted_Out_I, DelayAdjusted_Out_Q,Fs,2000) ;
[DelayAdjusted_In_I, DelayAdjusted_In_Q, DelayAdjusted_Out_I, DelayAdjusted_Out_Q]             = AdjustPowerAndPhase(DelayAdjusted_In_I, DelayAdjusted_In_Q, DelayAdjusted_Out_I, DelayAdjusted_Out_Q, 0) ;
[DelayAdjusted_In_I, DelayAdjusted_In_Q, DelayAdjusted_Out_I, DelayAdjusted_Out_Q]             = AdjustPowerAndPhase(DelayAdjusted_In_I, DelayAdjusted_In_Q, DelayAdjusted_Out_I, DelayAdjusted_Out_Q, 0) ;

In_I_mean1=mean(DelayAdjusted_In_I); In_Q_mean1=mean(DelayAdjusted_In_Q);
Out_I_mean1=mean(DelayAdjusted_Out_I); Out_Q_mean1=mean(DelayAdjusted_Out_Q);

% [InI1, InQ1, OutI_WithoutDPD1, OutQ_WithoutDPD1]=AdjustPowerAndPhase(InI, InQ, OutI_WithoutDPD, OutQ_WithoutDPD, 0) ;
% In_I_mean1=mean(InI1); In_Q_mean=mean(InQ1);
% Out_I_mean=mean(OutI_WithoutDPD1); Out_Q_mean=mean(OutQ_WithoutDPD1);
...
xlabel('In-phase','fontsize',28,'fontname','Times New Roman','fontweight','b');
ylabel('Quadrature','fontsize',28,'fontname','Times New Roman','fontweight','b');   
hold off
