...
fG        = 3000e3;       % Gaurd band for the modulated signal - Used to calculated ACLR and ACPR from the downloaded I/Q signals
...
%
%
ESGAdd='TCPIP::192.168.1.103::INSTR';   % set the address of signal generator
%
