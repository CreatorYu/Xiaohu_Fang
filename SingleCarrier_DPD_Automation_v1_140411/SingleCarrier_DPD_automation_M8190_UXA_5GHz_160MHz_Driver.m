...
FsampleTx        = 800e6;         % The sampling rate of the I/Q input files - In 'ESG' mode the sampling clock of the ESG will be set to the same value       %to be linked to signal
...
switch DPD_type
    case {'Volterra_DDR_ET', 'Volterra_DDR'}
        ...
        VolterraParameters.Order           = [ 9  0  7  0  0  0  0  0  0  0   0   ] ;%[ 7  0  5  0  3  0  0  0  0  0   0   ] ;
...
fG        = 600e3;       % Gaurd band for the modulated signal - Used to calculated ACLR and ACPR from the downloaded I/Q signals
BW        = 160e6;        % Bandwidth of the modulated signal - Used to calculated ACLR and ACPR from the downloaded I/Q signals  %to be linked to signal
PAPR_limit = 11;
...
% PlotSpectrum(DelayAdjusted_In_I, DelayAdjusted_In_Q, DelayAdjusted_Out_I, DelayAdjusted_Out_Q) ;
 ...
 %  ps(sig_nospurs, FsampleRx)
    ...
    [OUT_I_ACP, OUT_Q_ACP] = setMeanPower(OUT_I_ACP,OUT_Q_ACP,0);
    PlotSpectrum(In_I_beforeDPD, In_Q_beforeDPD,OUT_I_ACP, OUT_Q_ACP,100,5*BW);
