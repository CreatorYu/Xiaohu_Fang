...
p_sg=0;
Fcarrier  = 5.7e9;       % Center frequency of the modulated signal
...
%     [In_I, In_Q, out_I1, out_Q1]                = UnifyLength(In_I, In_Q, ResampledRecI, ResampledRecQ);
    ...
    [DelayAdjusted_In_I, DelayAdjusted_In_Q, DelayAdjusted_Out_I, DelayAdjusted_Out_Q, timedelay1] = AdjustDelay(In_I, In_Q, out_I1, out_Q1,Fs,4000) ;
...
N1=length(DelayAdjusted_In_I);
In1=complex(DelayAdjusted_In_I, DelayAdjusted_In_Q);
Out1=complex(DelayAdjusted_Out_I, DelayAdjusted_Out_Q);
    plot(1:1000,abs(In1(1:1000)),'-r',1:1000,abs(Out1(1:1000)),'-b')
    plot(1:1000,abs(Out1(1:1000))/abs(In1(1:1000)),'-r')
