...
p_sg=-18;
Fcarrier  = 3e9;       % Center frequency of the modulated signal
...
FsampleTx        = 500e6;         % The sampling rate of the I/Q input files - In 'ESG' mode the sampling clock of the ESG will be set to the same value       %to be linked to signal
FsampleRx        = 500e6;         % The sampling rate of the receiver (max 160MHz)
...
%
%
ESGAdd='TCPIP::192.168.1.102::INSTR';   % set the address of signal generator
%
%DP821A_IP='TCPIP0::192.168.1.105::INSTR';        % set the address of voltage source
IP         = '192.168.1.104';                     % set the address of spectrum analyzer
Freq       = Fcarrier;                                    
RefLev     = -7;
FsampleRx = FsampleTx;
