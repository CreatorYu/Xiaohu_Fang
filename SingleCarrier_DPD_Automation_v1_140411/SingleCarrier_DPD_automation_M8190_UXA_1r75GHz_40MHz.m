...
% p_sg=-31.0;
Fcarrier  = 1.75e9;       % Center frequency of the modulated signal
...
Expansion_Margin = 0.5;           % Used for high speed AWG only. It is used to maintain the average power of AWG when the PAPR of the pre-distorted signal increases.
...
GainExpansion_value = 0;        % Expansion of the original input in dB
...
switch DPD_type
    case {'Volterra_DDR_ET', 'Volterra_DDR'}
        ...
        VolterraParameters.Order           = [ 9  0  5  0  3  0  0  0  0  0   0   ] ;%[ 7  0  5  0  3  0  0  0  0  0   0   ] ;
