...
%  InI_beforeDPD_path = '64QAM_100MHz_In_I_1000r0_PAPR_7r2_12_2us.txt';
%  InQ_beforeDPD_path = '64QAM_100MHz_In_Q_1000r0_PAPR_7r2_12_2us.txt';
 
%%%%% 256QAM LTE 100 MHz   2023.2.21
...
%    InI_beforeDPD_path = '256QAM_100MHz_In_I_500r0_PAPR_7r8_24_3us.txt';
%   InQ_beforeDPD_path = '256QAM_100MHz_In_Q_500r0_PAPR_7r8_24_4us.txt';
    
%%%%% 5G 64QAM LTE 200 MHz   2023.4.6
% InI_beforeDPD_path = '64QAM_100MHz_In_I_1000r0_PAPR_6r6_12_2us.txt';
% InQ_beforeDPD_path = '64QAM_100MHz_In_Q_1000r0_PAPR_6r6_12_2us.txt';
%%%%% WCDMA 10C - 50 MHz
...
BW        = 100e6;         % Bandwidth of the modulated signal - Used to calculated ACLR and ACPR from the downloaded I/Q signals  %to be linked to signal
Num_points=12000;
...
p_sg=0;
Fcarrier  = 30e9;       % Center frequency of the modulated signal
FramTime  = Num_points/(5*BW);      % Total frame time for the modulated signal
...
% 
% 
% sed for high speed AWG only. It is used to maintain the average power of AWG when the PAPR of the pre-distorted signal increases.
...
Measure_Pout_Eff    = 'false';     % Set to 'True' to measure the average power and efficiency when making final DPD measurements
...
IP         = '192.168.1.108';                     % set the address of spectrum analyzer
...
% %Linear PA:
% if Fcarrier==4.85e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,3.19);%Idsm=85.5mA
%     elseif Fcarrier ==4.9e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,3.26);%Idsm=88.9mA
%     elseif Fcarrier ==5.0e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,3.26);%Idsm=72.4mA
%     elseif Fcarrier ==5.1e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,3.36); %Idsm=65.9mA    
%     elseif Fcarrier ==5.2e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,3.33); %Idsm=59.6mA
%     elseif Fcarrier ==5.3e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,3.34); %Idsm=60mA
%     elseif Fcarrier ==5.4e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,3.34); %Idsm=60mA
%     elseif Fcarrier ==5.5e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,3.52); %Idsm=56.7mA
%     elseif Fcarrier ==5.6e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,3.71); %Idsm=44.7mA
%     elseif Fcarrier ==5.7e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,4.02); %Idsm=39mA
%     elseif Fcarrier ==5.8e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,4.24); %Idsm=34mA
%     elseif Fcarrier ==5.9e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,4.46); %Idsm=31.7mA
%     else
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,4.63);%Idsm=16.6mA
% end
% %
% Wideband DPA bias:
% if Fcarrier==4.4e9
...
%     elseif Fcarrier ==5.2e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,4.33); %Idsm=57mA
%     elseif Fcarrier ==5.4e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,4.4); %Idsm=57mA
%     elseif Fcarrier ==5.6e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,4.64); %Idsm=50.7mA
%     elseif Fcarrier ==5.8e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,4.99); %Idsm=44.9mA
%     elseif Fcarrier ==6.0e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,5.32); %Idsm=35.8mA
%     elseif Fcarrier ==6.2e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,5.42); %Idsm=38.9mA
%     elseif Fcarrier ==6.4e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,5.15); %Idsm=44.7mA
...
%     AvgPower=MATLAB_directSCPI_NRPZxx_Avg_Power_my(Fcarrier);
%     Pout_measured_with_DPD = AvgPower- Mea_Attenuator_MMWave(Fcarrier);   
%
...
%          Mea_DC=PowerSupply_DP821A(DP821A_IP);
         ...
         I_m_with_DPD = 0;
         V_a_with_DPD = 28;
         I_a_with_DPD = fun_PowerSupply_HMP2030(HMP2030_IP);
         %Pout_measured_with_DPD = meanPower_FSW-Mea_Attenuator_2(Fcarrier);
         Pout_measured_with_DPD = Pout_NRPZ86-Mea_Attenuator_MMWave(Fcarrier);
         Pdc_measured_with_DPD  = V_m_with_DPD*I_m_with_DPD+V_a_with_DPD*I_a_with_DPD;
         DE_measured_with_DPD = 100*10^((Pout_measured_with_DPD-30)/10) / Pdc_measured_with_DPD;
     end
...
%  PlotAMPM(Pr_I, Pr_Q, Pr_I_up, Pr_Q_up) ;
    ...
    [EVM_dB , ~] = EVM_calculate (DelayAdjusted_In_I,DelayAdjusted_In_Q,DelayAdjusted_Out_I,DelayAdjusted_Out_Q);
    
    % Downsample the recieved data to 5*BW to get the correct ACLR and ACPR 
    [UpsampleACP, DownsampleACP] = rat(5*BW/Fs);
...
%           Mea_DC=PowerSupply_DP821A(DP821A_IP);
         ...
         I_m_without_DPD = 0;
         V_a_without_DPD = 28;
         I_a_without_DPD = fun_PowerSupply_HMP2030(HMP2030_IP);
%          Pout_measured_without_DPD = meanPower_FSW-Mea_Attenuator_2(Fcarrier);
         Pout_measured_without_DPD = Pout_NRPZ86-Mea_Attenuator_MMWave(Fcarrier);
