...
%% I
    figure()
        ...
        hold on
            ...
            legend('Measured I','Volterra I','Static I');
        hold off
%% Q
    figure()
        ...
        hold on
            ...
            legend('Measured Q','Volterra Q','Static Q');
        hold off
%% AM/AM
    figure()
        ...
        hold on
            ...
            legend('Measured AMAM','Volterra AMAM','Static AMAM');
        hold off  
%% AM/PM
    figure()
        hold on
            ...
            legend('Measured AMPM','Volterra AMPM','Static AMPM');
        hold off
    ...
    figure()
        ...
        hold on
            ...
            H = plot(msspectrum(h,Static.Vout-Measured.Vout,'centerdc',Fs));
                set(H,'Color','GREEN');
            legend('Measured PSD','Volterra PSD','Static PSD','Volterra Error PSD','Static Error PSD');
        hold off    
