...
p_sg=-29.2;
Fcarrier  = 4.9e9;       % Center frequency of the modulated signal
...
UXA_Atten             = 12;                                       % The mechanical attenuation in dB for the PXA when dowloading the signal. From 6 to 24 with steps of 2 dB
...
%%%%% Single carrier aggregated LTE - 80 MHz
% InI_beforeDPD_path = 'SC_80M_I_fs_1e+09_PAPR_5.6_6.7_QPSK_1ms_16xUPS.txt';
% InQ_beforeDPD_path = 'SC_80M_Q_fs_1e+09_PAPR_5.6_6.7_QPSK_1ms_16xUPS.txt';
%%%%% Receiver Calibration, Fs = 400e6, 201 tones, -100 to 100 MHz
% InI_beforeDPD_path = 'MT_I.txt';
% InQ_beforeDPD_path = 'MT_Q.txt';

fG        = 750e3;       % Gaurd band for the modulated signal - Used to calculated ACLR and ACPR from the downloaded I/Q signals
...
for IterationCount = 1:NofIteration
 ...
 %   Fcarrier_array{1}                 = Fcarrier ;
    ...
    PlotSpectrum(I_corr, Q_corr,I_corr, Q_corr)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
