...
for IterationCount = 1:NofIteration
    ...
    if strcmp(Receiver_type, 'PXA')
        ...
        if strcmp(Transmitter_type,'AWG')
            AWG_M8190A_Output_OFF(RF_ channel);
        elseif strcmp(Transmitter_type,'ESG')
            ESG_RF_OFF_SingleCarrier(ESGAdd)
        end
    end
...
if strcmp(Receiver_type, 'PXA')
    ...
    if strcmp (Measure_Pout_Eff,'True')
        ...
        Pout_measured_without_DPD = PM_obj.measure;
...
[In_I_withoutDPD,In_Q_withoutDPD,out_I1_withoutDPD,out_Q1_withoutDPD]                           = UnifyLength(In_I_withoutDPD, In_Q_withoutDPD, ResampledRecI, ResampledRecQ, data_length-200);
