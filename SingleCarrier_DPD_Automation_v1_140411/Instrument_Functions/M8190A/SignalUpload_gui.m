function varargout = SignalUpload_gui(varargin)
% SIGNALUPLOAD_GUI MATLAB code for SignalUpload_gui.fig
%      SIGNALUPLOAD_GUI, by itself, creates a new SIGNALUPLOAD_GUI or raises the existing
%      singleton*.
%
%      H = SIGNALUPLOAD_GUI returns the handle to a new SIGNALUPLOAD_GUI or the handle to
%      the existing singleton*.
%
%      SIGNALUPLOAD_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SIGNALUPLOAD_GUI.M with the given input arguments.
%
%      SIGNALUPLOAD_GUI('Property','Value',...) creates a new SIGNALUPLOAD_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SignalUpload_gui_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SignalUpload_gui_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SignalUpload_gui

% Last Modified by GUIDE v2.5 10-Mar-2014 14:54:34

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SignalUpload_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @SignalUpload_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SignalUpload_gui is made visible.
function SignalUpload_gui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SignalUpload_gui (see VARARGIN)

% Choose default command line output for SignalUpload_gui
...
% UIWAIT makes SignalUpload_gui wait for user response (see UIRESUME)
% uiwait(handles.iqtool);


% --- Outputs from this function are returned to the command line.
function varargout = SignalUpload_gui_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
insertRow(handles, 'Seq', {'', '' , false , '', '', '', false, ''});
