...
% Last Modified by GUIDE v2.5 11-Mar-2014 15:33:52
...
try
    switch (type)
        ...
        case {3 4}  % N5110A (3) and Signal Studio (4) format   I/Q interleaved with Markers in low order bits
            if (type == 3)
                byteOrder = 'ieee-le';
            else
                byteOrder = 'ieee-be';
...
% --- Executes during object creation, after setting all properties.
function pushbuttonChannelMapping_CreateFcn(hObject, eventdata, handles)
% hObject    handle to pushbuttonChannelMapping (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
