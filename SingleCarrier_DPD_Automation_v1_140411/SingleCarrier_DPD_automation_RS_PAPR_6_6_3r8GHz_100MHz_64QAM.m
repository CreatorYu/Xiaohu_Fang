...
%%%%% 5G 64QAM LTE 100 MHz   2022.10.16
...
FramTime  = 20e-6;      % Total frame time for the modulated signal
...
%
IP_HMP='TCPIP::192.168.1.104::5025::SOCKET';
...
%         DE_measured_with_DPD = 100*10^((Pout_measured_with_DPD-30)/10) / Pdc_measured_with_DPD;
         ...
         V_m_with_DPD =28;
         %I_m_with_DPD=fun_PowerSupply_HMP2030(IP_HMP);
