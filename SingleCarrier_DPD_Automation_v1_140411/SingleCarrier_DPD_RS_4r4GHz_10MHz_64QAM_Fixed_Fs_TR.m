...
p_sg=-22.65;
Fcarrier  = 4.4e9;       % Center frequency of the modulated signal
...
%          Pout_measured_without_DPD = meanPower_FSW-Mea_Attenuator_2(Fcarrier);
         Pout_measured_without_DPD = Pout_NRPZ86-Mea_Attenuator_2(Fcarrier);
