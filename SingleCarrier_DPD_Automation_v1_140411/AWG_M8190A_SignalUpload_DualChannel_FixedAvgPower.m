function AWG_M8190A_SignalUpload_DualChannel_FixedAvgPower(SignalsCell, CarrierFreqCell, SampleFreqCell, SampleFreqAWG, CorrectionEnabled, DisplaySignal,Expansion_Margin, PAPR_input, PAPR_original, channel2_fine_delay)
...
%     elseif channel == 1
%         channelMapping = [1 0; 0 0] ; %Set I to channel 1 
%     elseif channel == 0
...
%     end
    ...
    iqtotaldata  = real(iqtotaldata); % iqtotaldata  is channel 1 data
    iqtotaldata2 = real(iqtotaldata2); % iqtotaldata2 is channel 2 data
    iqtotaldata2 = FineTimeDelay_Adjust_CarrierLevel(iqtotaldata2, SampleFreqAWG, channel2_fine_delay);
    
  
    
     if (CorrectionEnabled)
        iqtotaldata = iqcorrection(iqtotaldata, fs);
        iqtotaldata2 = iqcorrection(iqtotaldata2, fs);
     end
     iqtotaldata  = real(iqtotaldata);
     iqtotaldata2 = real(iqtotaldata2);
     
     iqtotaldata  = iqtotaldata + 1i*iqtotaldata2;
