...
SG=SignalGenerator_E8267D(19,-10);
...
UXA_Atten             = 14;                                       % The mechanical attenuation in dB for the PXA when dowloading the signal. From 6 to 24 with steps of 2 dB
...
for IterationCount = 1:NofIteration
    ...
    [meanPower, maxPower, PAPR_input] = checkPower(In_I_cal, In_Q_cal, 1) ;  % Check the PAPR of the input file to be uploaded to the transmitter
        ...
        [meanPower, maxPower, PAPR_input] = checkPower(In_I_AWG, In_Q_AWG, 1)
  %     
 %% Apply calibration
