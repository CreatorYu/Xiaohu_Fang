...
FramTime  = 0.5e-3;      % Total frame time for the modulated signal
...
FsampleTx        = 50e6;         % The sampling rate of the I/Q input files - In 'ESG' mode the sampling clock of the ESG will be set to the same value       %to be linked to signal
FsampleRx        = 50e6;         % The sampling rate of the receiver (max 160MHz)
...
HMP2030_IP='TCPIP::192.168.1.100::5025::SOCKET';
Freq       = Fcarrier;                                    
RefLev     = 3;
FsampleRx = FsampleTx;
