...
%InI_beforeDPD_path = '256QAM_400MHz_In_I_1000r0_PAPR_8_5_test_1.txt';
%InQ_beforeDPD_path = '256QAM_400MHz_In_Q_1000r0_PAPR_8_5_test_1.txt';
InI_beforeDPD_path = '256QAM_400MHz_In_I_2000r0_PAPR_8r4_12_2us.txt';
InQ_beforeDPD_path = '256QAM_400MHz_In_Q_2000r0_PAPR_8r4_12_2us.txt';
% InI_beforeDPD_path = '256QAM_400MHz_In_I_1200r0_PAPR_8r6_12_2us.txt';
% InQ_beforeDPD_path = '256QAM_400MHz_In_Q_1200r0_PAPR_8r6_12_2us.txt';
...
% InI_beforeDPD_path = 'I_Input_PreDist_1.txt';
% InQ_beforeDPD_path = 'Q_Input_PreDist_1.txt';
...
fG        = 4000e3;       % Gaurd band for the modulated signal - Used to calculated ACLR and ACPR from the downloaded I/Q signals
...
n_BW=5;
p_sg=10;
Fcarrier  = 5e9;       % Center frequency of the modulated signal
Fsample_desired  = n_BW*BW;     % The sampling rate of the DPD modeing. Fsample_desired < FsampleRx
Fs=Fsample_desired;               %
...
FsampleRx        = 2000e6;         % The sampling rate of the receiver (max 160MHz)
...
NofDPDPoints     = 30000;         % # of points used in DPD identification
...
%
DP821A_IP='TCPIP0::192.168.1.103::INSTR';        % set the address of voltage source
IP         = '192.168.1.105';                     % set the address of spectrum analyzer
HMP2030_IP='TCPIP::192.168.1.101::5025::SOCKET';
Freq       = Fcarrier;                                    
RefLev     = -18;
% FsampleRx = FsampleTx;
...
%  PlotAMPM(Pr_I, Pr_Q, Pr_I_up, Pr_Q_up) ;
 ...
 %  ps(sig, FsampleRx);
    sig_nospurs = remove_spurious_specific(sig, n_BW*BW, [0 0]);
...
%     PlotSpectrum(In_I, In_Q,ResampledRecI, ResampledRecQ,1,FsampleTx);
    ...
    [freq, spectrum] = Calculated_Spectrum(OUT_I_ACP, OUT_Q_ACP, n_BW*BW);
...
% 
 if strcmp (Measure_Pout_Eff,'True')   
      ...
      %Mea_DC=PowerSupply_DP821A(DP821A_IP);
         ...
         V_m_with_DPD = 28;
         I_m_with_DPD = fun_PowerSupply_HMP2030(HMP2030_IP)-0.001;
         %Pout_measured_with_DPD = meanPower_FSW-Mea_Attenuator_MMWave(Freq);
         Pout_measured_with_DPD = Pout_NRPZ86-Mea_Attenuator_MMWave(Freq);
         Pdc_measured_with_DPD  = V_m_with_DPD*I_m_with_DPD+V_a_with_DPD*I_a_with_DPD;
         DE_measured_with_DPD = 100*10^((Pout_measured_with_DPD-30)/10) / Pdc_measured_with_DPD;
 end
...
% PlotSpectrum(DelayAdjusted_In_I, DelayAdjusted_In_Q, DelayAdjusted_Out_I, DelayAdjusted_Out_Q) ;
 ...
 %  ps(sig_nospurs, FsampleRx)
    ...
    [OUT_I_ACP, OUT_Q_ACP] = setMeanPower(OUT_I_ACP,OUT_Q_ACP,0);
    PlotSpectrum(In_I_beforeDPD, In_Q_beforeDPD,OUT_I_ACP, OUT_Q_ACP,n_BW*BW);
...
%         DE_measured_with_DPD = 100*10^((Pout_measured_with_DPD-30)/10) / Pdc_measured_with_DPD;
        ...
        V_a_without_DPD = 0;
         I_a_without_DPD = 0;
         V_m_without_DPD = 28;
        I_m_without_DPD = fun_PowerSupply_HMP2030(HMP2030_IP)-0.001;
         % Pout_measured_without_DPD = meanPower_FSW-Mea_Attenuator_SLCG(Fcarrier)+0.2;
