...
fG        = 200e3;       % Gaurd band for the modulated signal - Used to calculated ACLR and ACPR from the downloaded I/Q signals
...
FramTime  = 2.5e-3;      % Total frame time for the modulated signal
...
%         DE_measured_with_DPD = 100*10^((Pout_measured_with_DPD-30)/10) / Pdc_measured_with_DPD;
         ...
         V_a_with_DPD = Mea_DC(1);
         I_a_with_DPD = Mea_DC(2)-0.001;
         V_m_with_DPD = 16;
         I_m_with_DPD = fun_PowerSupply_HMP2030(HMP2030_IP);
         Pout_measured_with_DPD = meanPower_FSW-Mea_Attenuator_SLCG(Fcarrier);
         Pdc_measured_with_DPD  = V_m_with_DPD*I_m_with_DPD+V_a_with_DPD*I_a_with_DPD;
         DE_measured_with_DPD = 100*10^((Pout_measured_with_DPD-30)/10) / Pdc_measured_with_DPD;
     end
...
%         DE_measured_with_DPD = 100*10^((Pout_measured_with_DPD-30)/10) / Pdc_measured_with_DPD;
          ...
          Mea_DC=PowerSupply_DP821A(DP821A_IP);
        V_a_without_DPD = Mea_DC(1);
         I_a_without_DPD = Mea_DC(2);
         V_m_without_DPD = 16;
        I_m_without_DPD = fun_PowerSupply_HMP2030(HMP2030_IP);
         Pout_measured_without_DPD = meanPower_FSW-Mea_Attenuator_SLCG(Fcarrier);
