function [errorcode, errorcode_description] = agt_awg_clearddsscenario(varargin)
% Agilent N6030 Series Matlab Interface, Release 1.25
% Copyright © 2004,2005,2006 Agilent Technologies, Inc.
%
% This function removes a previously created DDS scenario.
%
% function [ errorcode, errorcode_description] = agt_awg_clearddsscenario(handle,scenariohandle)
%
% Output:        
...
%   scenariohandle          integer     Optional: removes referenced scenario  
%
...
if( nargin == 1)
    [errorcode, errorcode_description] = N6030MEX('clearddsscenario',varargin{1},-1);
    return;
end
...
[errorcode, errorcode_description] = N6030MEX('clearddsscenario',varargin{1},varargin{2});
