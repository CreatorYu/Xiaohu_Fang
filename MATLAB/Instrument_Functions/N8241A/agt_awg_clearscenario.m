function [errorcode, errorcode_description] = agt_awg_clearscenario(varargin)
% Agilent N6030 Series Matlab Interface, Release 1.25
% Copyright © 2004,2005,2006 Agilent Technologies, Inc.
%
% This function removes a previously created scenario.
%
% function [ errorcode, errorcode_description] = agt_awg_clearscenario(handle,scenariohandle)
%
% Output:        
...
if( nargin == 1)
    [errorcode, errorcode_description] = N6030MEX('clearscenario',varargin{1},-1);
    return;
end
...
[errorcode, errorcode_description] = N6030MEX('clearscenario',varargin{1},varargin{2});
