...
%load('PA_data_Pulse2022-10-25-13-10.mat')
%load('PA_Doherty_wideband_data_CW_4_4_6_6G_2023-04-13-18-15.mat')
%load('PA_Doherty_wideband_data_CW_4_5_6_7G_2023-04-13-21-58.mat')
%load('PA_Doherty_wideband_data_CW_4_4_6_6G_2023-04-14-15-06.mat')
load('PA_Doherty_wideband_data_CW_4_4_6_6G_2023-04-15-13-06.mat')
%load('PA_Doherty_wideband_data_CW_4_4_6_8G_2023-04-13-22-28.mat')
%
f_start =4.4e9;
f_stop =6.6e9;
f_step =0.1e9;
...
set(gcf,'color','w');
% axis([26,42,20,70]);
h=legend('4.4GHz','4.6GHz','4.8GHz','5GHz','5.2GHz','5.4GHz');
set(h,'fontsize',14,'fontname','Times New Roman')
% title('DE vs Normalized Pout for various x_n','fontsize',14,'fontname','Times New Roman');
xlabel('Output Power (dBm)','fontsize',15,'fontname','Times New Roman','fontweight','b');
...
set(gcf,'color','w');
axis([26,42,20,70]);
h=legend('5.6GHz','5.8GHz','6.0GHz','6.2GHz','6.4GHz','6.6GHz');
set(h,'fontsize',14,'fontname','Times New Roman')
% title('DE vs Normalized Pout for various x_n','fontsize',14,'fontname','Times New Roman');
xlabel('Output Power (dBm)','fontsize',15,'fontname','Times New Roman','fontweight','b');
