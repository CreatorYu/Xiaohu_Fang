...
%     if freq==4.8e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,3.8);
%     elseif freq > 4.8e9 && freq <= 5.1e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,3.9);
%     elseif freq >= 5.2e9 && freq < 5.4e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,4);
%     elseif freq >= 5.4e9 && freq < 5.6e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,4.2);
%     elseif freq >= 5.6e9 && freq <= 5.8e9
...
%              end
 ...
 data_file_name = [ 'PA_Doherty_linear_data_CW_5_8_5_8G_' datestr(now,'yyyy-mm-dd-HH-MM' )];
