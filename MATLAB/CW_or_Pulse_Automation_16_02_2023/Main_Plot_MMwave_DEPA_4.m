...
close all
%
% load('PA_data_Pulse_P_35_26_Vg_2_4_2022-10-26-19-51.mat')
% performance1=Performan_PA;
% Performan_PA=[];
% % 
% load('PA_data_Pulse_P_26_15_Vg_2_4_2022-10-26-20-05.mat')
% performance2=Performan_PA;
% Performan_PA=[];
% % 
% load('PA_data_Pulse_P_15_10_Vg_2_4_2022-10-26-20-13.mat')
% performance3=Performan_PA;
% save('DEPA_2_4.mat','performance1','performance2','performance3');
load('DEPA_2_4.mat');

load('driver_data2022-10-26-23-59.mat','Pout_real')
Pin_PA=Pout_real;
Pout_real=[];
...
Pin_real=[]
Pin_real=[Pin_real1;Pin_real2(1:N1,:);Pin_real3];
% Pin_real=Pin_PA;
Pout_real=[Pout_real1;Pout_real2(1:N1,:);Pout_real3];
Gain_real=[Gain_real1;Gain_real2(1:N1,:);Gain_real3];
DE_real=[DE_real1;DE_real2(1:N1,:);DE_real3];
PAE_real=[PAE_real1;PAE_real2(1:N1,:);PAE_real3];
...
plot(RFfreq,max(PAE_real), '-m*');
plot(RFfreq,DE_6dB,'-c^');
plot(RFfreq,PAE_6dB, '-bv');
set(gcf,'color','w');
axis([24,30,10,40]);
h=legend('Saturation DE','Saturation PAE','6dB DE','6dB PAE');
set(h,'fontsize',14,'fontname','Times New Roman')
% title('DE vs Normalized Pout for various x_n','fontsize',14,'fontname','Times New Roman');
xlabel('frequency (GHz)','fontsize',15,'fontname','Times New Roman','fontweight','b');
...
set(gcf,'color','w');
axis([20,38,0,40]);
h=legend('28GHz','28.5GHz','29GHz','29.5GHz','30GHz');
set(h,'fontsize',14,'fontname','Times New Roman')
% title('DE vs Normalized Pout for various x_n','fontsize',14,'fontname','Times New Roman');
xlabel('Output Power (dBm)','fontsize',15,'fontname','Times New Roman','fontweight','b');
ylabel('PAE (%)','fontsize',15,'fontname','Times New Roman','fontweight','b');    
...
set(gcf,'color','w');
axis([20,38,10,20]);
h=legend('24.0GHz','24.5GHz','25GHz','25.5GHz','26GHz','26.5GHz','27GHz');
set(h,'fontsize',14,'fontname','Times New Roman')
% title('DE vs Normalized Pout for various x_n','fontsize',14,'fontname','Times New Roman');
xlabel('Output Power (dBm)','fontsize',15,'fontname','Times New Roman','fontweight','b');
ylabel('Gain (dB)','fontsize',15,'fontname','Times New Roman','fontweight','b');    
...
set(gcf,'color','w');
axis([20,38,10,20]);
h=legend('27.5GHz','28GHz','28.5GHz','29GHz','29.5GHz','30GHz');
set(h,'fontsize',14,'fontname','Times New Roman')
% title('DE vs Normalized Pout for various x_n','fontsize',14,'fontname','Times New Roman');
xlabel('Output Power (dBm)','fontsize',15,'fontname','Times New Roman','fontweight','b');
ylabel('Gain (dB)','fontsize',15,'fontname','Times New Roman','fontweight','b');    
