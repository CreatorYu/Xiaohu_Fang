...
for freq=f_start:f_step:f_stop
 ...
 data_file_name = [ 'PA_SLCG_data_CW_1_8G_12V_' datestr(now,'yyyy-mm-dd-HH-MM' )];
...
hold on
for i=1:Nf
    plot(Pout_real,DE_real,linestyle1(i,:),'linewidth',1)
end
% for i=1:Nx
...
set(gcf,'color','w');
axis([20,42,0,80]);
h=legend('1GHz','1.2GHz','1.4GHz','1.6GHz','1.8GHz','2GHz','2.2GHz','2.4GHz','2.6GHz','2.8GHz','3GHz');
...
hold on
for i=1:Nf
    plot(Pout_real,Gain_real,linestyle1(i,:),'linewidth',1)
end
% for i=1:Nx
%     plot(Pout_dB_mark(:,i),eff_mark(:,i),linestyle1(i,2:3),'linewidth',2);
%     plot(Pout_dB(:,i),eff(:,i),linestyle1(i,1:2),'linewidth',2);
...
hold on
for i=1:Nf
    plot(Pout_real,PAE_real,linestyle1(i,:),'linewidth',1)
end
% for i=1:Nx
%     plot(Pout_dB_mark(:,i),eff_mark(:,i),linestyle1(i,2:3),'linewidth',2);
%     plot(Pout_dB(:,i),eff(:,i),linestyle1(i,1:2),'linewidth',2);
...
hold on
for i=1:Nf
    plot(Pout_real,Im_real,linestyle1(i,:),'linewidth',2);
end
set(gcf,'color','w');

for i=1:Nf
 plot(Pout_real,Ia_real,linestyle1(i+1,1:2),'linewidth',2);
end
h=legend('Main','Aux');
% set(h,'fontsize',14,'fontname','Times New Roman')
% title('DE vs Normalized Pout for various x_n','fontsize',14,'fontname','Times New Roman');
