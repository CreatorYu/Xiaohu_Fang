...
load('PA_Doherty_linear_data_CW2023-04-08-15-33.mat')
f_start =4.8e9;
f_stop =6e9;
f_step =0.1e9;
...
set(gcf,'color','w');
h=legend('4.8GHz','5GHz','5.2GHz','5.4GHz','5.6GHz','5.8GHz','6GHz');
for i=1:2:Nf
 plot(Pout_real(:,i),Ia_real(:,i),linestyle1(i,1:2),'linewidth',2);
end
% set(h,'fontsize',14,'fontname','Times New Roman')
% title('DE vs Normalized Pout for various x_n','fontsize',14,'fontname','Times New Roman');
