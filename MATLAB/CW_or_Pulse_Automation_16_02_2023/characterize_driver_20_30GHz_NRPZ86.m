...
data_file_name = [ 'driver_data_SBP_24G_31G_' datestr(now,'yyyy-mm-dd-HH-MM' )];
...
set(gcf,'color','w');
% axis([-20,0,0,30]);
h=legend('23GHz','23.5GHz','24GHz','24.5GHz','25GHz','25.5GHz','26GHz','26.5GHz','27GHz','27.5GHz','28GHz','28.5GHz','29GHz','29.5GHz','30GHz');
...
set(gcf,'color','w');
% axis([-20,0,0,30]);
h=legend('23GHz','23.5GHz','24GHz','24.5GHz','25GHz');
set(h,'fontsize',14,'fontname','Times New Roman')
% title('DE vs Normalized Pout for various x_n','fontsize',14,'fontname','Times New Roman');
xlabel('Input Power (dBm)','fontsize',15,'fontname','Times New Roman','fontweight','b');
ylabel('Gain (dB)','fontsize',15,'fontname','Times New Roman','fontweight','b');    
