...
%load('PA_SLCG_data_CW_1_0_2_0G_12V_2023-04-13-11-49.mat')
% load('PA_SLCG_data_CW_1G_2G_12V_2023-04-17-20-53.mat')
% data_l=data;
% %load('PA_SLCG_data_CW_2_1G_3_0G_12V2023-04-12-17-21.mat')
% load('PA_SLCG_data_CW_2_2G_3G_12V2023-04-17-19-51.mat')
% data_u=data;
% data_com=[data_l data_u];
% data=data_com
%
load('SLCG_2_data_CW_2_0G_2_0G_16V2023-05-01-15-58.mat')
f_start =2.0e9;
f_stop =3e9;
f_step =0.1e9;
...
set(gcf,'color','w');
axis([20,42,6,14]);
h=legend('2.0GHz','2.1GHz','2.2GHz','2.3GHz','2.4GHz','2.5GHz')
set(h,'fontsize',14,'fontname','Times New Roman')
% title('DE vs Normalized Pout for various x_n','fontsize',14,'fontname','Times New Roman');
...
set(gcf,'color','w');
axis([20,42,5,13]);
h=legend('2.6GHz','2.7GHz','2.8GHz','2.9GHz','3.0GHz')
set(h,'fontsize',14,'fontname','Times New Roman')
% title('DE vs Normalized Pout for various x_n','fontsize',14,'fontname','Times New Roman');
xlabel('Output Power (dBm)','fontsize',15,'fontname','Times New Roman','fontweight','b');
ylabel('Gain (dB)','fontsize',15,'fontname','Times New Roman','fontweight','b');    
