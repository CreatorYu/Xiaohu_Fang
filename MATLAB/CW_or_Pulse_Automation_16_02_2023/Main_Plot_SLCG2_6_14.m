...
% f_step =0.5e9;
%
%load('SLCG_2_data_pulse_2_1G_3_6G_16V2023-06-13-20-58.mat');
%load('SLCG_2_data_pulse_2G_3_6G_16V2023-06-13-20-44.mat');
%load('SLCG_2_data_pulse_0_6G_3_6G_16V2023-06-15-17-06.mat')
%load('SLCG_2_data_pulse_0_6G_2_0G_16V2023-06-16-11-01.mat')
%load('SLCG_2_data_pulse_2_1G_3_6G_16V2023-06-16-12-08.mat');
% load('SLCG_2_data_pulse_0_6G_3_6G_16V2023-06-16-12-11.mat')
load('SLCG_2_data_pulse_0_6G_3_6G_16V2023-06-16-12-29.mat')
...
linestyle1=char('-ro', '-m*', '-c^', '-bv', '-gs', '-y>', '-k<','-r*', '-m^', '-cv','-bs','-g>', '-y<', '-ko','-ro', '-m*', '-c^', '-bv');
%
figure(1)
hold on
...
set(gcf,'color','w');
axis([0.6,3.6,30,75]);
h=legend('Saturation DE','6dB-OBO DE','7.5dB-OBO DE');
set(h,'fontsize',14,'fontname','Times New Roman')
% title('DE vs Normalized Pout for various x_n','fontsize',14,'fontname','Times New Roman');
xlabel('frequency (GHz)','fontsize',15,'fontname','Times New Roman','fontweight','b');
...
set(gcf,'color','w');
axis([24,42,6,15]);
h=legend('0.6GHz','0.9GHz','1.2GHz','1.5GHz','1.8GHz','2.1GHz','2.4GHz','2.7GHz','3.0GHz','3.3GHz','3.6GHz');
set(h,'fontsize',14,'fontname','Times New Roman')
% title('DE vs Normalized Pout for various x_n','fontsize',14,'fontname','Times New Roman');
...
set(gcf,'color','w');
axis([24,42,20,75]);
h=legend('0.6GHz','0.9GHz','1.2GHz','1.5GHz','1.8GHz','2.1GHz');
set(h,'fontsize',14,'fontname','Times New Roman')
% title('DE vs Normalized Pout for various x_n','fontsize',14,'fontname','Times New Roman');
xlabel('Output Power (dBm)','fontsize',15,'fontname','Times New Roman','fontweight','b');
...
set(gcf,'color','w');
axis([26,42,20,75]);
h=legend('2.4GHz','2.7GHz','3.0GHz','3.3GHz','3.6GHz');
set(h,'fontsize',14,'fontname','Times New Roman')
% title('DE vs Normalized Pout for various x_n','fontsize',14,'fontname','Times New Roman');
xlabel('Output Power (dBm)','fontsize',15,'fontname','Times New Roman','fontweight','b');
ylabel('DE (%)','fontsize',15,'fontname','Times New Roman','fontweight','b');    
...
set(gcf,'color','w');
% axis([-20,0,0,30]);
h=legend('2.1GHz','2.4GHz','2.7GHz','3.0GHz','3.3GHz','3.6GHz');
set(h,'fontsize',14,'fontname','Times New Roman')
% title('DE vs Normalized Pout for various x_n','fontsize',14,'fontname','Times New Roman');
xlabel('Output Power (dBm)','fontsize',15,'fontname','Times New Roman','fontweight','b');
ylabel('Gain (dB)','fontsize',15,'fontname','Times New Roman','fontweight','b');    
