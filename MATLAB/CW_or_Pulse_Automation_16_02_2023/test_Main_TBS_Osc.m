...
%% variables
%function Avg_reading=fun_Main_TI_Osc(scale1,tri)
% 固定记录长度为20K
visa_brand = 'ni';
scale1 = 'CH1:SCALE 0.2';
tri = 'TRIGGER:A:LEVEL:CH2 0.100';
scale2 = 'CH1:SCALE 0.2';
% tri2 = 'TRIGGER:A:LEVEL:CH1 0.080';
visa_address = 'USB::0x0699::0x03C4::C025110::INSTR';
