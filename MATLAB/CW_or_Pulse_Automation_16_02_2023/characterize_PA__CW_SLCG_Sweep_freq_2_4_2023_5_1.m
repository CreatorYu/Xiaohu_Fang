...
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,4.8);
%     elseif freq == 2.2e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,4.7);
%     elseif freq == 2.3e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,4.6);
%     elseif freq == 2.4e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,4.5);
%     elseif freq == 2.5e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,4.5);
%     elseif freq == 2.6e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,4.4);
%     elseif freq >= 2.7e9 && freq <= 2.8e9
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,4.8);
%     else
%         fun_PowerSetting_HMP2030(HMP2030_IP,HMP_channel,4.6);
%     end
...
%              end
            ...
            Pout=p_out-Attenuation(f_idx)+0.2;
...
%  data_file_name = [ 'SLCG_2_data_CW_2_4G_16V' datestr(now,'yyyy-mm-dd-HH-MM' )];
