...
time_now = clock;
dir_name = strcat('4r8GHz',date,'_',int2str(time_now(4)),'_',int2str(time_now(5)),'_',int2str(time_now(6)));
UXA_Atten             = 12;     
%
%
%
...
% path('C:\Documents\Xiaohu_Fang\SingleCarrier_DPD_Automation_v1_140411\Measurements\Measurement19-Sep-2017_17_59_4',path)
% InI_beforeDPD_path = 'I_Input_PreDist_4r8_160MHz.txt';
% InQ_beforeDPD_path = 'Q_Input_PreDist_4r8_160MHz.txt';
BW = 160e6;
fG = 600e3;
PAPR_limit = 11;
FsampleTx = 800e6;
