...
time_now = clock;
dir_name = strcat('4r7GHz',date,'_',int2str(time_now(4)),'_',int2str(time_now(5)),'_',int2str(time_now(6)));
UXA_Atten             = 12;   
FsampleAWG            = 4e9; 
%
...
% InI_beforeDPD_path = 'I_Input_PreDist_4r7_160MHz.txt';
% InQ_beforeDPD_path = 'Q_Input_PreDist_4r7_160MHz.txt';
BW = 160e6;
fG = 600e3;
PAPR_limit = 11;
FsampleTx = 800e6;
...
UXAAdd                = 'GPIB0::18::INSTR';                                       % The GPIB address of the PXA
                                    % The mechanical attenuation in dB for the PXA when dowloading the signal. From 6 to 24 with steps of 2 dB
