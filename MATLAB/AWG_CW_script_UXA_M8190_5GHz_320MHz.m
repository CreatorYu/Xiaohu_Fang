...
%%%%% 16 carrier aggregated LTE - 320 MHz
InI_beforeDPD_path = 'LTE_16x20M_I_fs_1e+09_PAPR_8.5_11.2_64QAM_1ms_4xUPS.txt';
InQ_beforeDPD_path = 'LTE_16x20M_Q_fs_1e+09_PAPR_8.5_11.2_64QAM_1ms_4xUPS.txt';
%%%%% single carrier aggregated LTE - 320 MHz
% InI_beforeDPD_path = 'SC_320M_I_fs_1e+09_PAPR_7.2_8.9_64QAM_1ms_4xUPS.txt';
% InQ_beforeDPD_path = 'SC_320M_Q_fs_1e+09_PAPR_7.2_8.9_64QAM_1ms_4xUPS.txt';
...
[meanPower, maxPower, PAPR_original] = checkPower(In_I,In_Q, 1);
...
%
[UpsampleTx, DownsampleTx] = rat(FsampleAWG/FsampleRx);
    ResampledRecI = resample(RecI_captured,UpsampleTx,DownsampleTx,100);
    ResampledRecQ = resample(RecQ_captured,UpsampleTx,DownsampleTx,100);
    PlotSpectrum(In_I, In_Q,ResampledRecI, ResampledRecQ,1,FsampleAWG);
    ...
    [DelayAdjusted_In_I, DelayAdjusted_In_Q, DelayAdjusted_Out_I, DelayAdjusted_Out_Q, timedelay1] = AdjustDelay(In_I, In_Q, out_I1, out_Q1,FsampleAWG,1000) ;
    ...
    [freq, spectrum] = Calculated_Spectrum(DelayAdjusted_Out_I,DelayAdjusted_Out_Q,FsampleAWG);
...
cd([pwd '\Measurements']);
time_now = clock;
dir_name = strcat('5GHz_320MHz',date,'_',int2str(time_now(4)),'_',int2str(time_now(5)),'_',int2str(time_now(6)));
mkdir(dir_name)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%% Writing files
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
