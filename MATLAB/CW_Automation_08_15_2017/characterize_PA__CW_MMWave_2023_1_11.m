...
%
Pout_Driver=mea_Pout(p1:p2,f1:f2);
S21_Driver=S21(p1:p2,f1:f2);
%
S21=[]; mea_Pout=[];
%
%% Start Measurement
...
%               I=fun_Main_TI_Osc(scale1,tri);
 ...
 data_file_name = [ 'PA_data_MMWave_Doherty_CW' datestr(now,'yyyy-mm-dd-HH-MM' )];
 save(data_file_name, 'Performan_PA','S21'); 
