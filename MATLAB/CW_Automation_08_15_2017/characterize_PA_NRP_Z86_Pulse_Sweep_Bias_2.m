...
for Vgm=Vgm_min:Vgm_step:Vgm_max
    ...
    fun_N6705_Voltage_Set(Lan_addr,Vgm,1);
    fun_N6705_Voltage_Set(Lan_addr,Vgm,3);
...
data_file_name = [ 'PA_data_Pulse_Vgm' datestr(now,'yyyy-mm-dd-HH-MM' )];
...
h=legend('1.87V','1.92V','1.97V','2.02V','2.12V');
set(h,'fontsize',14,'fontname','Times New Roman')
title('26GHz','fontsize',14,'fontname','Times New Roman');
xlabel('Output Power (dBm)','fontsize',15,'fontname','Times New Roman','fontweight','b');
ylabel('Gain (dB)','fontsize',15,'fontname','Times New Roman','fontweight','b');    
hold off    
grid on
...
hold on
for i=1:N3
    plot(Pout_real(:,1,i),DE_real(:,1,i),linestyle1(i,:),'linewidth',2);
end
set(gcf,'color','w');
% axis([30,40,10,20]);
h=legend('1.87V','1.92V','1.97V','2.02V','2.12V');
