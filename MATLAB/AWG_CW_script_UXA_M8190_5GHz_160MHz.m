...
% InI_beforeDPD_path = 'I_Input_PreDist_5r0_160MHz.txt';
% InQ_beforeDPD_path = 'Q_Input_PreDist_5r0_160MHz.txt';
BW = 160e6;
fG = 600e3;
PAPR_limit = 11;
FsampleTx = 800e6;
...
PlotSpectrum(In_I_AWG, In_Q_AWG,In_I_AWG, In_Q_AWG,2,FsampleAWG);
        %%
